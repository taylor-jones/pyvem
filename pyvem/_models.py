...
ExtensionQuerySortByTypes: Dict[str, int] = AttributeDict({
    ...
    'Relevance': 0,
    #
    # The results will be sorted as per Last Updated date of the extensions
    # with recently updated at the top
    #
    'LastUpdatedDate': 1,
    #
    ...
    'TrendingMonthly': 9,
    #
    # The results will be sorted as per ReleaseDate of the extensions
    # (date on which the extension first went public)
    #
    'ReleaseDate': 10,
    #
    # The results will be sorted as per Author defined in the VSix/Metadata.
    # If not defined, publisher name is used This is specifically needed by
    # VS IDE, other (new and old) clients are not encouraged to use this
    #
    'Author': 11,
    #
